...
class SummaryTest(unittest.TestCase):
    ...
    def test_image_with_one_channel(self):
        compare_proto(
            summary.image("dummy", tensor_N(shape=(1, 8, 8)), dataformats="CHW"), self
        )

    def test_image_with_four_channel(self):
        compare_proto(
            summary.image("dummy", tensor_N(shape=(4, 8, 8)), dataformats="CHW"), self
        )
    ...
    def test_image_with_four_channel_batched(self):
        compare_proto(
            summary.image("dummy", tensor_N(shape=(2, 4, 8, 8)), dataformats="NCHW"),
            self,
        )
