...
_DATATYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="DATA_TYPE_BOOL", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DATA_TYPE_FLOAT64",
            index=3,
            number=3,
            serialized_options=None,
            type=None,
...
_STATUS = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="STATUS_SUCCESS", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STATUS_FAILURE", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STATUS_RUNNING", index=3, number=3, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_SORTORDER = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="ORDER_ASC", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ORDER_DESC", index=2, number=2, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_HPARAMINFO.fields_by_name[
    "domain_discrete"
].containing_oneof = _HPARAMINFO.oneofs_by_name["domain"]
_HPARAMINFO.oneofs_by_name["domain"].fields.append(
...
_SESSIONGROUP_HPARAMSENTRY.fields_by_name[
    "value"
...
_LISTSESSIONGROUPSREQUEST.fields_by_name[
    "aggregation_type"
].enum_type = _AGGREGATIONTYPE
_LISTSESSIONGROUPSREQUEST.fields_by_name[
    "aggregation_metric"
].message_type = _METRICNAME
...
_COLPARAMS.fields_by_name["filter_regexp"].containing_oneof = _COLPARAMS.oneofs_by_name[
    "filter"
]
_COLPARAMS.oneofs_by_name["filter"].fields.append(
...
_COLPARAMS.fields_by_name[
    "filter_interval"
].containing_oneof = _COLPARAMS.oneofs_by_name["filter"]
_COLPARAMS.oneofs_by_name["filter"].fields.append(
...
HParamInfo = _reflection.GeneratedProtocolMessageType(
    "HParamInfo",
    (_message.Message,),
    {
...
MetricName = _reflection.GeneratedProtocolMessageType(
    "MetricName",
    (_message.Message,),
    {
...
SessionGroup = _reflection.GeneratedProtocolMessageType(
    "SessionGroup",
    (_message.Message,),
    {
        "HparamsEntry": _reflection.GeneratedProtocolMessageType(
            "HparamsEntry",
            (_message.Message,),
            {
...
ListSessionGroupsRequest = _reflection.GeneratedProtocolMessageType(
...
ColParams = _reflection.GeneratedProtocolMessageType(
    "ColParams",
    (_message.Message,),
    {
...
ListSessionGroupsResponse = _reflection.GeneratedProtocolMessageType(
    "ListSessionGroupsResponse",
    (_message.Message,),
    {
...
ListMetricEvalsRequest = _reflection.GeneratedProtocolMessageType(
