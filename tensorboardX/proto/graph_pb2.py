...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        tensorboardX_dot_proto_dot_node__def__pb2.DESCRIPTOR,
        tensorboardX_dot_proto_dot_versions__pb2.DESCRIPTOR,
    ],
)
...
_GRAPHDEF.fields_by_name[
    "node"
].message_type = tensorboardX_dot_proto_dot_node__def__pb2._NODEDEF
_GRAPHDEF.fields_by_name[
    "versions"
].message_type = tensorboardX_dot_proto_dot_versions__pb2._VERSIONDEF
