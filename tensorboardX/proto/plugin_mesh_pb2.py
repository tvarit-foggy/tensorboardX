...
_MESHPLUGINDATA_CONTENTTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="VERTEX", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FACE", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="COLOR", index=3, number=3, serialized_options=None, type=None
        ),
    ],
...
MeshPluginData = _reflection.GeneratedProtocolMessageType(
    "MeshPluginData",
    (_message.Message,),
    {
